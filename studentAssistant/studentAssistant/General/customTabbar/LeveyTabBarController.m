...
- (id)initWithViewControllers:(NSArray *)vcs imageArray:(NSArray *)arr
{
	...
	if (self != nil)
	{
		...
		_tabBar = [[LeveyTabBar alloc] initWithFrame:CGRectMake(0, _containerView.frame.size.height - kTabBarHeight, ScreenWidth, kTabBarHeight ) buttonImages:arr];
...
//       
//   }else{
//     [[UINavigationBar appearance] setBarTintColor:UIColorFromRGB(0x6ab800)];
