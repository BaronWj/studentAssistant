...
//	BOOL isActivityIndicator = [indicator isKindOfClass:[UIActivityIndicatorView class]];
    BOOL isActivityIndicator = [indicator isKindOfClass:[KDActivityIndicatorView class]];
...
//		[(UIActivityIndicatorView *)indicator startAnimating];
        self.indicator = MB_AUTORELEASE([[KDActivityIndicatorView alloc] initWithActivityIndicatorStyle:KDActivityIndicatorViewStyleWhite]);
		[(KDActivityIndicatorView *)indicator startAnimating];
