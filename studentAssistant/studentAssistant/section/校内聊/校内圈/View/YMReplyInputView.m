         ...
         lineBreakMode:(NSLineBreakMode)lineBreakMode
{
    ...
    {
        size = [self sizeForFont:font constrainedToSize:constraint lineBreakMode:lineBreakMode];
    }
...
@synthesize autoResizeOnKeyboardVisibilityChanged = _autoResizeOnKeyboardVisibilityChanged;
